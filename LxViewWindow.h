...
public:
	...
	void set_view_back_color(COLORREF view_back_color_)
	{
		view_back_color = view_back_color_;
	}
	int get_top_pos()
	{
		return offset_y;
...
private:
	ViewWindow() : border_height(20), offset_x(0), offset_y(0) {}
